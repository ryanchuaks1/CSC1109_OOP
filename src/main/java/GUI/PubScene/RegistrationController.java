...
public class RegistrationController implements Initializable{
    ...
    void handleConfirmButtonAction(ActionEvent event) throws IOException {
        ...
        String errormessage = verifyRegister(Email, Password, Password2, firstName, lastName, countrycode, Contact, BirthDate);
        ...
        if (errormessage == "") {
            ...
            if(event.getSource()==confirmButton){
                ...
                //load up OTHER FXML document (May have to check to link to another verification page through email instead)
    ...
    public String verifyRegister(String email, String password, String password2, String fName, String lName, String cCode, String contactNumber,
			String birthDate) {
		String errormessage = "";
